package com.javaedge.feeds.service;
...
import com.javaedge.feeds.mapper.FeedsMapper;
...
public class FeedsService {
    ...
    public void create(Feeds feeds, String accessToken) {
        ...
        // 推送到粉丝的列表中 -- 后续这里应该采用MQ解决性能问题
        // 先获取粉丝 id 集合,通过关注服务去获取（需 rpc）
        List<Integer> followers = findFollowers(dinerInfo.getId());
        // 推送 Feed
        // 作为分数
